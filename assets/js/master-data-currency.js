...
$(function () {
    ...
    s.length &&
        (e = s.DataTable({
            ajax: assetsPath + "json/list-currency.json",
            columns: [
                { data: "currency_name" },
                { data: "base_currency" },
                { data: "abbreviation" },
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (e, t, a, n) {
                        return '<a href="./master-data-currency-edit.html" class="text-primary"><i class="mdi mdi-pencil-outline me-1"></i><span>Edit</span></a><a href="javascript:;" class="text-danger" data-bs-toggle="modal" data-bs-target="#deleteConfirmation"><i class="mdi mdi-delete-outline"></i><span>Delete</span></a>';
                    },
                },
            ],
            order: [[2, "desc"]],
            ...
            buttons: [
                ...
                },
                {
                    ...
                    action: function () {
                        window.location.href = "./master-data-currency-add.html";
                    },
                },
            ],
