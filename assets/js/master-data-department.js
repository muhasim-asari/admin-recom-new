            ...
            columnDefs: [
		{
                ...
                },
                {
                    ...
                    render: function (e, t, a, n) {
                        return '<a href="./master-data-department-edit.html" class="text-primary"><i class="mdi mdi-pencil-outline me-1"></i><span>Edit</span></a><a href="javascript:;" class="text-danger" data-bs-toggle="modal" data-bs-target="#deleteConfirmation"><i class="mdi mdi-delete-outline"></i><span>Delete</span></a>';
            ...
            buttons: [
                ...
                {
                    text: '<i class="mdi mdi-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Add Department</span>',
                    className: "add-new btn btn-primary mx-3",
                    action: function () {
                        window.location.href = "./master-data-department-add.html";
                    },
                },
            ],
        })),
        // Show Delete Confirmation
        $(".datatables-department tbody").on("click", ".delete-record", function () {
    ...
    $(document).ready(function () {
        ...
        function handleFormSubmit(event) {
            ...
            if (assetGroupName && description) {
                toastr.success("Berhasil Membuat Department Baru", "Create Success!");
            } else {
                toastr.error("Gagal Membuat Department Baru", "Create Error!");
            }
        }

        $("#createDepartment").submit(handleFormSubmit);
        $("#updateDepartment").submit(handleFormSubmit);
    });