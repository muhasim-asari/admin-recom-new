...
$(function () {
  ...
  s.length &&
    (e = s.DataTable({
      ajax: assetsPath + "json/list-supplier.json",
      columns: [
        { data: "company_name" },
        { data: "company_phone" },
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (e, t, a, n) {
            return '<div class="d-flex gap-2"><a href="./master-data-supplier-edit.html" class="text-primary"><i class="mdi mdi-pencil-outline me-1"></i><span>Edit</span></a><a href="javascript:;" class="text-danger" data-bs-toggle="modal" data-bs-target="#deleteConfirmation"><i class="mdi mdi-delete-outline me-1"></i><span>Delete</span></a>';
          },
        },
      ],
      order: [[2, "desc"]],
      ...
      buttons: [
        ...
        },
        {
          ...
          action: function () {
            window.location.href = "./master-data-supplier-add.html";
          },
        },
      ],
    })),
  ...
  $("#deleteConfirmation").on("click", ".btn-confirm", function () {
    ...
    var table = $(".datatables-master-supplier").DataTable();
