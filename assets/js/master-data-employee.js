            ...
            columnDefs: [
		{
                ...
                },
                {
                    ...
                    render: function (e, t, a, n) {
                        return '<a href="./master-data-employee-edit.html" class="text-primary"><i class="mdi mdi-pencil-outline me-1"></i><span>Edit</span></a><a href="javascript:;" class="text-danger" data-bs-toggle="modal" data-bs-target="#deleteConfirmation"><i class="mdi mdi-delete-outline"></i><span>Delete</span></a>';
            ...
            buttons: [
                ...
                {
                    text: '<i class="mdi mdi-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Add Employee</span>',
                    className: "add-new btn btn-primary mx-3",
                    action: function () {
                        window.location.href = "./master-data-employee-add.html";
                    },
                },
            ],
        })),
  ...
  $("#deleteConfirmation").on("click", ".btn-confirm", function () {
    ...
    $(document).ready(function () {
        ...
        function handleFormSubmit(event) {
            ...
            if (employeeName && assetGroupName && description) {
                toastr.success("Berhasil Membuat Employee Baru", "Create Success!");
            } else {
                toastr.error("Gagal Membuat Employee Baru", "Create Error!");
            }
        }

        $("#createdEmployee").submit(handleFormSubmit);
        $("#updateEmployee").submit(handleFormSubmit);
    });