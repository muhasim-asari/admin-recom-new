    ...
    return (
      (function () {
        ...
        var b = [
          ...
          T = x.contains("layout-menu-offcanvas")
            ? "static-offcanvas"
            : x.contains("layout-menu-fixed")
            ? "fixed"
            : x.contains("layout-menu-fixed-offcanvas")
            ? "fixed-offcanvas"
            : "static",
          E = (function () {
            function t(e) {
              ...
              if (
                ...
                if (
                  ...
                  var N = this.settings.controls.indexOf("style");
                  -1 !== N &&
                    (this.settings.controls = this.settings.controls
                      .slice(0, N)
                      .concat(this.settings.controls.slice(N + 1)));
                }
                (this.settings.onSettingsChange =
                  ...
                  this.setLayoutMenuFlipped(
                    this.settings.layoutMenuFlipped,
                    !1
                  ),
                  this.setDropdownOnHover(
                    this.settings.showDropdownOnHover,
                    !1
                  ),
                  this.setLayoutNavbarFixed(
                    this.settings.layoutNavbarFixed,
                    !1
                  ),
                  this.setLayoutFooterFixed(
              ...
              (s = [
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    if (
                      ...
                      "fixed" === this.settings.layoutType ||
                      "fixed-offcanvas" === this.settings.layoutType
                        ? i &&
                          s &&
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    this._hasControls("layoutMenuFlipped") &&
                      ((this.settings.layoutMenuFlipped = t),
                    ...
                    if (e !== this.settings.lang || i) {
                      ...
                      [
                        ...
                        var e = s.container.querySelector(
                          ".template-customizer-t-".concat(t)
                        );
                        e && (e.textContent = o[t]);
                      });
                      for (
                        ...
                        n[l].querySelector(
                          ".template-customizer-theme-name"
                ...
                },
                {
                  ...
                  value: function () {
                    if (!this._ssr) {
                      ...
                      this._controls.layoutMenuFlipped &&
                        (e
                          ? (this._controls.layoutMenuFlipped.removeAttribute(
                              "disabled"
                            ),
                            this._controls.layoutMenuFlipped.classList.remove(
                              "disabled"
                            ))
                          : (this._controls.layoutMenuFlipped.setAttribute(
                              "disabled",
                              "disabled"
                            ),
                            this._controls.layoutMenuFlipped.classList.add(
                              "disabled"
                            ))),
                        ...
                        this._controls.layoutType &&
                          (e || s
                            ? this._controls.layoutType.removeAttribute(
                                "disabled"
                              )
                            : this._controls.layoutType.setAttribute(
                                "disabled",
                                "disabled"
                              ));
                    }
                  ...
                  value: function () {
                    ...
                    (t =
                      ...
                      -1 !==
                        ...
                        ? r
                        : this.settings.defaultLayoutType),
                      (this.settings.layoutType = t),
                      (this.settings.rtl =
                        "" !== e ? "true" === e : this.settings.defaultTextDir),
                      (this.settings.style =
                        -1 !== this.settings.styles.indexOf(s)
                          ? s
                          : this.settings.defaultStyle),
                      -1 ===
                        this.settings.styles.indexOf(this.settings.style) &&
                      ...
                      this._hasControls("style") ||
                        (this.settings.style = x.contains("dark-style")
                          ? "dark"
                          : "light"),
                      this._hasControls("layoutType") ||
                        (this.settings.layoutType = null),
                      this._hasControls("layoutMenuFlipped") ||
                        (this.settings.layoutMenuFlipped = null),
                      this._hasControls("showDropdownOnHover") ||
                        (this.settings.showDropdownOnHover = null),
                      this._hasControls("layoutNavbarFixed") ||
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    var p = this.container.querySelector(
                      ".template-customizer-themes"
                    );
                    if (this._hasControls("themes")) {
                      var m = p.querySelector(
                        ".template-customizer-themes-options"
                      );
                      this.settings.availableThemes.forEach(function (e) {
                        var s = t._getElementFromString(
                          '<div class="col-12"><div class="form-check"><input class="form-check-input" type="radio" name="themeRadios" id="themeRadios'
                            ...
                            .concat(
                              e.name,
                              '"><label class="form-check-label" for="themeRadios'
                            )
                            .concat(e.name, '">')
                    ...
                    var g = this.container.querySelector(
                    ...
                    if (
                      ...
                      var v = this.container.querySelector(
                        ".template-customizer-layoutType"
                      );
                      if (this._hasControls("layoutType")) {
                        (this._controls.layoutType = v.querySelector(
                      ...
                      if (
                        ...
                        (this._controls.showDropdownOnHover =
                          this._controls.showDropdownOnHover.querySelector(
                            "input"
                          )),
                          this.settings.showDropdownOnHover &&
                            this._controls.showDropdownOnHover.setAttribute(
                        ...
                        this._controls.showDropdownOnHover.addEventListener(
                          "change",
                          _
                        ),
                          this._listeners.push([
                        ...
                        this._controls.showDropdownOnHover.parentNode.removeChild(
                          this._controls.showDropdownOnHover
                        );
                      if (
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    this.container.classList[t ? "add" : "remove"](
                      "template-customizer-loading".concat(e ? "-theme" : "")
                    );
                  },
                },
                {
                  ...
                  value: function (t) {
                    ...
                    try {
                      e = localStorage.getItem(
                        "templateCustomizer-".concat(s, "--").concat(t)
                      );
                    } catch (t) {}
                    return String(e || "");
                  },
